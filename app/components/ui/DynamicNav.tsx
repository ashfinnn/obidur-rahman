...
import { FiHome, FiUser, FiGrid, FiMail, FiBriefcase } from "react-icons/fi";

// Updated items list including Experience
const navItems = [
  { id: "hero", icon: FiHome, label: "HOME" },
  { id: "about", icon: FiUser, label: "PROFILE" },
  { id: "experience", icon: FiBriefcase, label: "EXP" }, // Added here
      ...
      >
        {navItems.map((item) => (
          ...
          >
            ...
            {/* Active Indicator (Corner Square) */}
